...
export default function CategoryCreateDialog({onClose, onCreate, name, color}: Readonly<CategoryDialogProps>) {
    ...
    return (
        <div
            ...
            <div className="p-4 rounded bg-gray-100 dark:bg-gray-800 text-light-text dark:text-dark-text">
                ...
                />
                <button onClick={() => onCreate(categoryName, categoryColor)}
