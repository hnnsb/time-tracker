...
export default function CreateDialog({title, fields, onClose, onCreate}: Readonly<CreateDialogProps>) {
        ...
        <div
            ...
            <div className="p-4 rounded bg-gray-100 dark:bg-gray-800 text-light-text dark:text-dark-text">
                ...
                <div className="flex justify-end">
                    <button onClick={() => onCreate(values)} className="px-4 py-2 text-white bg-blue-600 rounded mr-2">
                        Save
                    </button>
